...
class Keyboard():
    ...
    def set_csv_df(self, csv_df): self.csv_df = csv_df
    def get_csv_df(self): return self.csv_df
    def set_csv(self, csv): self.csv = csv
    def get_csv(self): return self.csv
    def set_csv_onekey(self, csv_onekey): self.csv_onekey = csv_onekey
    def get_csv_onekey(self): return self.csv_onekey
    def set_csv_nonstat(self, csv_nonstat): self.csv_nonstat = csv_nonstat
    def get_csv_nonstat(self): return self.csv_nonstat
    ...
    def export_to_csv(self, password):
        ...
        merge_df.to_csv(self.get_csv_df(), sep=',', mode='a', header=False)
        ...
        with open(self.get_csv_onekey(), 'a', newline='') as file:
        ...
        with open(self.get_csv_nonstat(), 'a', newline='') as file:
            placeholder = [merge_df.iloc[0]["release_time"] - merge_df.iloc[0]["press_time"]]
