...
def main():
    ...
    csv_path_df, csv_path_full, csv_path_nonstat, csv_path_bare, csv_path_onekey, export_dir_path = prelude(name, 8)
...
def prelude(name, maxPwdLen):
    ...
    '''
    csv_name_df = "df_combi_" + name + ".csv"
    csv_path_df = os.path.join(export_dir_path, csv_name_df)

    csv_name_full = "combi_" + name + ".csv"
    csv_path_full = os.path.join(export_dir_path, csv_name_full)

    csv_name_semi = "nonstat_combi_" + name + ".csv"
    ...
    csv_name_5 = "onekey_combi_" + name + ".csv"
